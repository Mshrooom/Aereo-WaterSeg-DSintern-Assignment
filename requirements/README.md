...
The executed notebook exports `pip_freeze.txt`, which is the exact environment lock for the successful run. Do not claim a lock file was tested until the full Kaggle execution finishes.
